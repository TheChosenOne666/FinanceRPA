...
# 从 Skyvern Settings 读取 DATABASE_STRING，覆盖 alembic.ini 中的默认值
# financeRPA 共用 finrpa 库（M3.7 决策），DATABASE_STRING 指向 finrpa 库
from skyvern.config import settings as skyvern_settings

config.set_main_option("sqlalchemy.url", skyvern_settings.DATABASE_STRING)
