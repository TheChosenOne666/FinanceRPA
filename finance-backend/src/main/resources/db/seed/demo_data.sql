...
SELECT uuid_generate_v4(), 'banking_admin', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '平台管理员', 'o_demo_cmb', '招商银行演示', '信息技术部', 1, 0
WHERE NOT EXISTS (SELECT 1 FROM sys_user WHERE username = 'banking_admin');

INSERT INTO sys_user (user_id, username, password, real_name, org_id, org_name, dept_name, status, deleted)
SELECT uuid_generate_v4(), 'credit_operator', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '对公信贷操作员', 'o_demo_cmb', '招商银行演示', '对公信贷部', 1, 0
WHERE NOT EXISTS (SELECT 1 FROM sys_user WHERE username = 'credit_operator');

INSERT INTO sys_user (user_id, username, password, real_name, org_id, org_name, dept_name, status, deleted)
SELECT uuid_generate_v4(), 'credit_approver', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '对公信贷审批员', 'o_demo_cmb', '招商银行演示', '对公信贷部', 1, 0
WHERE NOT EXISTS (SELECT 1 FROM sys_user WHERE username = 'credit_approver');

INSERT INTO sys_user (user_id, username, password, real_name, org_id, org_name, dept_name, status, deleted)
SELECT uuid_generate_v4(), 'risk_viewer', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '风险管理员', 'o_demo_cmb', '招商银行演示', '风险管理部', 1, 0
WHERE NOT EXISTS (SELECT 1 FROM sys_user WHERE username = 'risk_viewer');

INSERT INTO sys_user (user_id, username, password, real_name, org_id, org_name, dept_name, status, deleted)
SELECT uuid_generate_v4(), 'compliance_approver', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '合规审计员', 'o_demo_cmb', '招商银行演示', '合规审计部', 1, 0
